...
const keyWordsNumDesk = 6
const keyWordsNumMobile = 4
...
const gMemes = [
  ...
  { id: 19, url: 'images/19.png', keywords: ['confused', 'dizzy', 'home'] },
  { id: 20, url: 'images/20.jpg', keywords: ['cry', 'sad', 'home']},
  { id: 21, url: 'images/21.jpg', keywords: ['smart', 'think', 'about','it']},
  { id: 22, url: 'images/22.jpg', keywords: ['button', 'Agutin', 'desperate']},
  { id: 23, url: 'images/23.jpg', keywords: ['Pablo ', 'Escobar', 'narcos']},
];
...
function getRandomTags() {
  let tags = getAllTags();
  let randomTags = [];
  let numOfWords =  (window.innerWidth < 400) ? keyWordsNumMobile : keyWordsNumDesk ;
